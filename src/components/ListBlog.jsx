            ...
            <View style={itemVertical.cardContent}>
              <View
                ...
                <View style={{ gap: 5, width: "70%" }}>
                  <Text style={itemVertical.cardCategory}>guide</Text>
                  <Text style={itemVertical.cardTitle}>
                    find healthy guide
                  </Text>
                </View>
                <ReceiptText color={colors.green(0.6)} variant="Linear" size={20} />
              </View>
              <View style={itemVertical.cardInfo}>
                <Clock size={10} variant="Linear" color={colors.green(0.6)} />
                <Text style={itemVertical.cardText}>Jul 25, 2023</Text>
                <MessageCircle size={10} variant="Linear" color={colors.green(0.6)} />
            ...
            <View style={itemVertical.cardContent}>
              <View
                style={{
                  ...
                  justifyContent: "space-between",}}>
                <View style={{ gap: 5, width: "70%" }}>
                  <Text style={itemVertical.cardCategory}>makanan</Text>
                  <Text style={itemVertical.cardTitle}>
            ...
            <View style={itemVertical.cardContent}>
              <View
                style={{
                  ...
                  justifyContent: "space-between",}}>
                <View style={{ gap: 5, width: "70%" }}>
                  <Text style={itemVertical.cardCategory}>trend</Text>
                  <Text style={itemVertical.cardTitle}>Sneaker Culture</Text></View>
                <ReceiptText color={colors.green(0.6)} variant="Linear" size={20} />
              </View>
              <View style={itemVertical.cardInfo}>
                <Clock size={10} variant="Linear" color={colors.green(0.6)} />
            ...
            <View style={itemVertical.cardContent}>
              <View
                ...
                <View style={{ gap: 5, width: "70%" }}>
                  ...
                  <Text style={itemVertical.cardTitle}>
                    Balancing Work and Well-being</Text>
                </View>
                <ReceiptText color={colors.green(0.6)} variant="Linear" size={20} />
              </View>
              <View style={itemVertical.cardInfo}>
...
const itemHorizontal = StyleSheet.create({
  ...
  cardText: {
    ...
    fontFamily: "Pjs-Medium",},
  cardIcon: {
    backgroundColor: colors.orange(0.33),
    padding: 5,
